...
//2. GET a specific joke --- path variable
...
//3. GET a jokes by filtering on the joke type --- query parameters
...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey) {
    ...
    res
      .status(404)
      .json({ error: "Your are not authorized to perform this action" });
  }
})
